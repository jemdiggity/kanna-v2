...
Direct LAN terminal observation is duplex from the release line's task-transfer protocol v2: once
...
request for every keystroke. A viewer connected to a protocol-v1 peer
